...
class Flash:
    ...
    def _fetch(self, url, log_errors=True):
        retries = 3
        ...
        for attempt in range(1, retries + 1):
            try:
                ...
                if not isinstance(data, dict) or 'values' not in data:
                    raise ValueError("unexpected response format (missing 'values')")
                return data
        ...
        while now <= self.to_date:
            ...
            if data is None:
                ...
                for outer in range(1, max_outer + 1):
                    ...
                    logger.warning("Giving up on {} after {}h of hourly retries".format(day_key, max_outer))
